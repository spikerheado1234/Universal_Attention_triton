...
#     dkc = torch.empty(b,h,n_,c_,d, dtype=xq.dtype, device=xq.device)
#     dvc = torch.empty(b,h,n_,c_,d, dtype=xq.dtype, device=xq.device)
#     dxq = torch.empty(b,h,r,_n,_c,d, dtype=xq.dtype, device=xq.device)
#     dstatic_src = torch.empty(b,h,n_,c_, dtype=xq.dtype, device=xq.device)
#     dstatic_dest = torch.empty(b,h,_n,_c, dtype=xq.dtype, device=xq.device)
